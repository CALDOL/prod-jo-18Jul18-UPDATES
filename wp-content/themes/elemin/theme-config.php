...
$themify_theme_config['panel']['styling']['tab']['page_wrap'] = array(
	'title' => __('Page Wrap', 'themify'),
	'id' => 'page_wrap',
	'element' => array(
		array(
			'title' => __('Page Wrap', 'themify'),
			...
			'module' => array(
				array(
					'name' => 'image-preview',
					'src' => 'uploads/bg/pagewrap/'
				),
				array(
					'name' => 'background-image',
					'target' => 'uploads/bg/pagewrap/'
				),
				'background-color',
				'background-repeat',
				'background-position',
...
$themify_theme_config['panel']['styling']['tab']['page_navigation'] = array(
	'title' => __('Page Navigation', 'themify'),
	'id' => 'page_navigation',
	'element' => array(
		array(
			'title' => __('Page Navigation (page 1, 2, 3, etc.)', 'themify'),
			'id' => 'page_navigation',
			'selector' => '.pagenav',
			'module' => array(
				'border'
		...
		array(
			'title' => __('Page Navigation Link', 'themify'),
			'id' => 'page_navigation_link',
			'selector' => '.pagenav a',
			'module' => array(
				'font-family',
				'color',
		...
		array(
			'title' => __('Page Navigation Hover', 'themify'),
			'id' => 'page_navigation_hover',
			'selector' => '.pagenav a:hover',
			'module' => array(
				'color',
				'background-color',
				'text-decoration'
		...
		array(
			'title' => __('Page Navigation Current', 'themify'),
			'id' => 'page_navigation_current',
			'selector' => '.pagenav .current',
			'module' => array(
				'color',
				'background-color'
			)
...
$themify_theme_config['panel']['styling']['tab']['footer'] = array(
	...
	'element' => array(
		...
		array(
			'title' => __('Footer Text Link', 'themify'),
			'id' => 'footer_text_link',
			'selector' => '.footer-text a',
			'module' => array(
				'color',
				'text-decoration',
			)
		...
		array(
			'title' => __('Footer Text Hover', 'themify'),
			'id' => 'footer_text_hover',
			'selector' => '.footer-text a:hover',
			'module' => array(
				'color',
				'text-decoration',
			)
