...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<div id="whats-new-avatar">
		<a href="<?php echo bp_loggedin_user_domain(); ?>">
			<?php //bp_loggedin_user_avatar( 'width=' . bp_core_avatar_thumb_width() . '&height=' . bp_core_avatar_thumb_height() ); ?>
			 <?php bp_loggedin_user_avatar( 'width=64&height=64'); ?>
		</a>
	</div>
	...
	<p class="activity-greeting"><?php if ( bp_is_group() )
		...
		//printf( __( "What are you doing/learning today, %s?", 'buddypress' ), bp_get_user_firstname( bp_get_loggedin_user_fullname() ) );
		printf( __( "What are you doing/learning today, %s?", 'buddypress' ), get_user_meta($bp->loggedin_user->id, 'first_name', true )); 
	?></p>
