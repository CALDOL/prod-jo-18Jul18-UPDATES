...
// _e( 'You have successfully created your account! Please log in using the username and password you have just created.', 'buddypress' ); 
 _e( 'You have successfully created your account and requested membership to the Platoon Leader Forum! You will receive an email confirming your request for membership.<br/><br/>
      You should receive an approval email within the next 24-48 hours, possibly a little longer over weekends/holidays.', 'buddypress' ); 
