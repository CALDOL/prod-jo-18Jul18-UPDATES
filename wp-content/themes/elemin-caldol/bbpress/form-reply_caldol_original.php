	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<?php if ( !bbp_is_reply_edit()):?>
			    ...
			    <h2 id='openNewReply' style='cursor:pointer;'>Reply to <?php echo substr(bbp_get_topic_title(), 0, 35); echo (strlen(bbp_get_topic_title()) > 35)?' ...':''?> <span id='newReplyToggle'></span></h2>				
				</legend>
				<div id="createNewReplyDiv" >
			<?php endif;?>	
				<?php //COMMENT THIS OUT SO IT DOESN'T SHOW THE BBCodes NOTICE ?>
				...
				<?php //SET THIS TO FALSE SO IT DOESN'T SHOW ?>
