	...
	<div id="new-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-form">
		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				<legend>
					...
					if ( bbp_is_topic_edit() )
						...
						echo "<h2 id='openNewDiscussion' style='cursor:pointer;'>Create New Discussion <span id='newDiscussionToggle'> (+)</span></h2>";
			...
			<?php if ( !bbp_is_topic_edit() ){?>
				...
				<?php if ($slug != 'start-discussion'){?>

						<div style='display: none; background-color:;' id="createNewDiscussionDiv">
					<?php }
					
					else {?>

					<div style='background-color:;' id="createNewDiscussion">
			...
			<?php }?>
						...
						<?php endif;?>
							...
							<p>
							<h1>here</h1>	<label for="bbp_forum_id"><?php _e( 'Forum:', 'bbpress' ); ?> </label><br />
								<?php
								bbp_dropdown( array(
