...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
	...
	<li class="bbp-header">
		...
		<div class="bbp-topic-post-date"><?php  echo "Posted on " . bbp_get_topic_post_date();  //_e( 'Creator',  'bbpress' ); ?></div>
		<!-- .bbp-topic-post-date -->
	...
	<?php // don't display this footer ?>
	<li style="display:none;" class="bbp-footer">
...
<!-- end child/content-single-topic-lead -->
